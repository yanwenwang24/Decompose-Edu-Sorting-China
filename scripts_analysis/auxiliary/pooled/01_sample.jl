...
write_parquet("data/samples/auxiliary/pooled/sample_women.parquet", sample_women)
write_parquet("data/samples/auxiliary/pooled/sample_men.parquet", sample_men)
write_parquet("data/samples/auxiliary/pooled/sample_women_married.parquet", sample_women_married)
