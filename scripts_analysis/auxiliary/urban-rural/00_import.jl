...
sample_women = DataFrame(read_parquet("data/samples/auxiliary/urban-rural/sample_women.parquet"))
sample_men = DataFrame(read_parquet("data/samples/auxiliary/urban-rural/sample_men.parquet"))
sample_women_married = DataFrame(read_parquet("data/samples/auxiliary/urban-rural/sample_women_married.parquet"))
