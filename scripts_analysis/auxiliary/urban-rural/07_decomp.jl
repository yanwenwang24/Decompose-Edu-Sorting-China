...
df = DataFrame(read_parquet("outputs/tables/auxiliary/urban-rural/df_for_decomp.parquet"))
...
# Save results
write_parquet("outputs/tables/auxiliary/urban-rural/decomp.parquet", decomp_df)
